...
public class OptionButtonPhotoTT<T> extends OptionControl {
    public int OPTION_BUTTON_PHOTO_PhotoTT_ID = 159725;


    private WpDataDB wpDataDB;
    private final WorkPlan workPlan = new WorkPlan();

    public OptionButtonPhotoTT(Context context, T document, OptionsDB optionDB, OptionMassageType msgType, Options.NNKMode nnkMode, UnlockCodeResultListener unlockCodeResultListener) {
