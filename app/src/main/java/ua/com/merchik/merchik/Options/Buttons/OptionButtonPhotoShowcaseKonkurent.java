...
public class OptionButtonPhotoShowcaseKonkurent<T> extends OptionControl {
    public static int OPTION_BUTTON_PhotoShowcaseKonkurent_ID = 174213;

    private WpDataDB wpDataDB;
    private final WorkPlan workPlan = new WorkPlan();

    public OptionButtonPhotoShowcaseKonkurent(Context context, T document, OptionsDB optionDB, OptionMassageType msgType, Options.NNKMode nnkMode, UnlockCodeResultListener unlockCodeResultListener) {
...
//                dataJson.addProperty("tradeMarkDBId", tradeMarkDB != null ? tradeMarkDB.getID() : "0");
                ...
                bundle.putString("subTitle", "В списке представлены образцы фотоотчетов. " +
                        "Для того, чтобы изготовить 'Фото витрины конкурентов' нажмите на соответствующую фотографию. " +
