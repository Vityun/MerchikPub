...
public class OptionButtonPhotoShowcaseCorporateBlock<T> extends OptionControl {
    ...
    public OptionButtonPhotoShowcaseCorporateBlock(Context context, T document, OptionsDB optionDB, OptionMassageType msgType, Options.NNKMode nnkMode, UnlockCodeResultListener unlockCodeResultListener) {
        ...
        try {
            try {
                ...
                bundle.putString("subTitle", "В списке представлены образцы фотоотчетов. " +
                        "Для того, чтобы изготовить 'Фото витрины наполненности' нажмите на соответствующую фотографию. " +
