...
//        int OSV = 0;            // ОсобоеВнимание
        ...
        if (optionDB.getOptionId().equals("157278") || optionDB.getOptionControlId().equals("157278")) {
            ...
            List<AdditionalRequirementsDB> additionalRequirements2 = AdditionalRequirementsRealm.getDocumentAdditionalRequirements(document, true, OPTION_CONTROL_PROMOTION_ID, null, null, null, null, null, null, null);
