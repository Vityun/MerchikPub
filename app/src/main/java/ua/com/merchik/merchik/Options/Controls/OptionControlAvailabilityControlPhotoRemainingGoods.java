 ...
 * // Контроль наличия Фото Остатков Товаров (по ОТСУТСТВУЮЩИМ товарам, ... если указано ОСВ то проверяем их, а если нет то проверяем ВСЕ ОТСУТСТВУЮЩИЕ).  Крое этой есть еще такая-же но с контролем наличия остатков по всем клиентам и отдельно по КОНКРЕТНОМУ клиенту
