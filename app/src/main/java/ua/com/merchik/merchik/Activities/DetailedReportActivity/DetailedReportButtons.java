...
//                Log.e("AdditionalRequirements", "data.size(): " + data.size());
                ...
                List<AdditionalRequirementsDB> data = RealmManager.INSTANCE.copyFromRealm(AdditionalRequirementsRealm.getData3(wpDataDB, HIDE_FOR_USER, ttCategory, 0));
