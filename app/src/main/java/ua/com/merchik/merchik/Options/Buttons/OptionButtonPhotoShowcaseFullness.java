...
public class OptionButtonPhotoShowcaseFullness<T> extends OptionControl {
    ...
    public OptionButtonPhotoShowcaseFullness(Context context, T document, OptionsDB optionDB, OptionMassageType msgType, Options.NNKMode nnkMode, UnlockCodeResultListener unlockCodeResultListener) {
